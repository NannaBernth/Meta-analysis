...
listoflists <- list(StudyID = c(49, 50, 51), ArticleID = 47, SAMPLE_SIZE_SZ = c(335, 182, 158),
SAMPLE_SIZE_HC = c(352, 184, 128), PITCH_F0_HC_M = c(142.4939, 123.8641, 137.0162), PITCH_F0_HC_SD = c(24.72409, 27.32127, 25.47117), PITCH_F0_SZ_M = c(156.2813, 137.6516, 150.8036), PITCH_F0_SZ_SD = c(24.72409, 27.32127, 25.47117))
...
ass3$Authors = NA
ass3$Article = NA
ass3$Year_publication = NA
ass3$PITCH_F0SD_HC_M = NA
ass3$PITCH_F0SD_HC_SD = NA
ass3$PITCH_F0SD_SZ_M = NA
ass3$PITCH_F0SD_SZ_SD = NA
